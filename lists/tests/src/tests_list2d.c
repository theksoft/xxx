...
static void list_count_errors() {
  CU_ASSERT_EQUAL(xxx_list2d_count(NULL), 0);
}
...
static void list_count_tests() {
  ...
  create_list(&l, n, 1);
  CU_ASSERT_EQUAL(xxx_list2d_count(&l), 1);
  check_list(&l, n, 1);
  create_list(&l, n, 2);
  CU_ASSERT_EQUAL(xxx_list2d_count(&l), 2);
  check_list(&l, n, 2);
  create_list(&l, n, 3);
  CU_ASSERT_EQUAL(xxx_list2d_count(&l), 3);
  check_list(&l, n, 3);
  create_list(&l, n, 4);
  CU_ASSERT_EQUAL(xxx_list2d_count(&l), 4);
  check_list(&l, n, 4);
}
...
static void list_push_errors() {
  basic_list_errors(xxx_list2d_push);
}
...
static void list_push_back_errors() {
  basic_list_errors(xxx_list2d_push_back);
}
...
static void list_pop_errors() {
  CU_ASSERT_PTR_NULL(xxx_list2d_pop(NULL));
}
...
static void list_pop_tests() {
  ...
  create_list(&l, n, 4);
  CU_ASSERT_PTR_EQUAL(xxx_list2d_pop(&l), &n[0]);
  CU_ASSERT_PTR_EQUAL(xxx_list2d_pop(&l), &n[1]);
  CU_ASSERT_PTR_EQUAL(xxx_list2d_pop(&l), &n[2]);
  CU_ASSERT_PTR_EQUAL(xxx_list2d_pop(&l), &n[3]);
  CU_ASSERT_PTR_NULL(xxx_list2d_pop(&l));
...
static void list_pop_back_errors() {
  CU_ASSERT_PTR_NULL(xxx_list2d_pop_back(NULL));
}
...
static void list_pop_back_tests() {
  ...
  create_list(&l, n, 4);
  CU_ASSERT_PTR_EQUAL(xxx_list2d_pop_back(&l), &n[3]);
  CU_ASSERT_PTR_EQUAL(xxx_list2d_pop_back(&l), &n[2]);
  CU_ASSERT_PTR_EQUAL(xxx_list2d_pop_back(&l), &n[1]);
  CU_ASSERT_PTR_EQUAL(xxx_list2d_pop_back(&l), &n[0]);
  CU_ASSERT_PTR_NULL(xxx_list2d_pop_back(&l));
  CU_ASSERT_PTR_NULL(l.head);
  CU_ASSERT(!l.count);
}
...
static void list_remove_errors() {
  basic_list_errors(xxx_list2d_remove);
}
...
static void list_find_errors() {
  ...
  CU_ASSERT_PTR_NULL(xxx_list2d_find(NULL, NULL, NULL));
  CU_ASSERT_PTR_NULL(xxx_list2d_find(NULL, NULL, &n[0]));
  CU_ASSERT_PTR_NULL(xxx_list2d_find(&l, NULL, NULL));
  CU_ASSERT_PTR_NULL(xxx_list2d_find(&l, NULL, &n[0]));
  CU_ASSERT_PTR_NULL(xxx_list2d_find(NULL, find_dummy, NULL));
  CU_ASSERT_PTR_NULL(xxx_list2d_find(NULL, find_dummy, &n[0]));
  check_list(&l, n, 4);
}
...
static void list_find_tests() {
  ...
  reset_ctrs();
  CU_ASSERT_PTR_NULL(xxx_list2d_find(&l, find_dummy, &n[0]));
  CU_ASSERT_EQUAL(ctrs.find, 0);
  ...
  reset_ctrs();
  CU_ASSERT_PTR_EQUAL(xxx_list2d_find(&l, find_dummy, &n[0]), &n[0]);
  CU_ASSERT_EQUAL(ctrs.find, 1);
  reset_ctrs();
  CU_ASSERT_PTR_EQUAL(xxx_list2d_find(&l, find_dummy, &n[1]), &n[1]);
  CU_ASSERT_EQUAL(ctrs.find, 2);
  reset_ctrs();
  CU_ASSERT_PTR_EQUAL(xxx_list2d_find(&l, find_dummy, &n[2]), &n[2]);
  CU_ASSERT_EQUAL(ctrs.find, 3);
  reset_ctrs();
  CU_ASSERT_PTR_EQUAL(xxx_list2d_find(&l, find_dummy, &n[3]), &n[3]);
  CU_ASSERT_EQUAL(ctrs.find, 4);
...
static void list_find_r_errors() {
  ...
  CU_ASSERT_PTR_NULL(xxx_list2d_find_r(NULL, NULL, NULL));
  CU_ASSERT_PTR_NULL(xxx_list2d_find_r(NULL, NULL, &n[0]));
  CU_ASSERT_PTR_NULL(xxx_list2d_find_r(&l, NULL, NULL));
  CU_ASSERT_PTR_NULL(xxx_list2d_find_r(&l, NULL, &n[0]));
  CU_ASSERT_PTR_NULL(xxx_list2d_find_r(NULL, find_dummy, NULL));
  CU_ASSERT_PTR_NULL(xxx_list2d_find_r(NULL, find_dummy, &n[0]));
  check_list(&l, n, 4);
}
...
static void list_find_r_tests() {
  ...
  CU_ASSERT_EQUAL(ctrs.find, 0);
  reset_ctrs();
  CU_ASSERT_PTR_NULL(xxx_list2d_find_r(&l, find_dummy, &n[0]));
  CU_ASSERT_EQUAL(ctrs.find, 0);
  ...
  CU_ASSERT_EQUAL(ctrs.find, 4);
  reset_ctrs();
  CU_ASSERT_PTR_EQUAL(xxx_list2d_find_r(&l, find_dummy, &n[0]), &n[0]);
  CU_ASSERT_EQUAL(ctrs.find, 4);
  reset_ctrs();
  CU_ASSERT_PTR_EQUAL(xxx_list2d_find_r(&l, find_dummy, &n[1]), &n[1]);
  CU_ASSERT_EQUAL(ctrs.find, 3);
  reset_ctrs();
  CU_ASSERT_PTR_EQUAL(xxx_list2d_find_r(&l, find_dummy, &n[2]), &n[2]);
  CU_ASSERT_EQUAL(ctrs.find, 2);
  reset_ctrs();
  CU_ASSERT_PTR_EQUAL(xxx_list2d_find_r(&l, find_dummy, &n[3]), &n[3]);
  CU_ASSERT_EQUAL(ctrs.find, 1);
...
static void check_list(xxx_list2d_t* list, xxx_list2d_node_t* table, size_t count) {
  ...
  CU_ASSERT_EQUAL(xxx_list2d_count(list), count);
